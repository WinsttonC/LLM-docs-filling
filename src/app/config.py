...
def description():
    ...
    Написание комментариев в процессе.
    """
    )
    ...
    **Точность поиска пропусков** - accuracy. \n
    Количество правильно размеченных/ количество неправильно размеченных или неразмеченных совсем.
    ...
    **Точность заполнения** зависела от используемого метода. \n
    ...
    формулировками данных пользователя в контексте документа \n
